...
#' @export
#' @examples
#' \dontrun{fg_leaders(x = 2015, y = 2015, qual = 400, pit_bat = "batter")}

fg_leaders <- function(x, y, league = "all", qual = "y", ind = 0, pit_bat) {
  switch(pit_bat,
         batter = fg_bat_leaders(x, y, league = "all", qual = "y", ind = 0),
         pitcher = fg_pitch_leaders(x, y, league = "all", qual = "y", ind = 0)
  )
}  
...
fg_bat_leaders <- function(x, y, league = "all", qual = "y", ind = 0) {
  ...
  if (ind == 0) {
    ...
    Seasons <- ifelse(x==y, x, paste0(x, "-", y))
    colnames(leaders) <- c
...
fg_pitch_leaders <- function(x, y, league = "all", qual = "y", ind = 0) {
