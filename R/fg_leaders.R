...
#' @export
#' @examples
#' \dontrun{fg_leaders(year = 2015, pit_bat = "batter")}

fg_leaders <- function(year, league = "all", qual = "y", ind = 0, pit_bat) {
  switch(pit_bat,
         batter = fg_bat_leaders(year, league, qual, ind),
         pitcher = fg_pitch_leaders(year, league, qual, ind)
  )
}  
...
fg_bat_leaders <- function(year, league = "all", qual = "y", ind = 0) {
...
#' 
#' @examples
#' \dontrun{fg_pitch_leaders(year = 2015, qual = 150)}

fg_pitch_leaders <- function(year, league = "all", qual = "y", ind = 0) {
